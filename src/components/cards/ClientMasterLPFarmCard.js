...
export default function ClientMasterLPFarmCard({ id, rewardTokenInfo, dividendTokenInfo, stakeType, stakeToken, subFarms=null, contractAddress, chainId, projectId, updateStore }) {
        ...
        >
            <CardContent sx={{ paddingLeft: 0, paddingRight: 0 }}>
                ...
                <Container maxWidth="lg" sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", }} >
                    ...
                    <Typography variant='p' sx={{ fontSize: 25, color: '#F0B90B' }}>
                        {dividendTokenInfo?.symbol ? dividendTokenInfo?.symbol : "NON"}
                    </Typography>
                </Container>
                <Divider sx={{ p: 3 }} />
                <Container maxWidth="lg" sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", }} >
            ...
            <Modal open={subStakingView} onBackdropClick={() => setSubStakingView(false)}>
                <Container direction="col" sx={{ ...modalStyled, width: 950 }}>
                    <Container sx={{ display: 'flex', justifyContent: 'center', p: 3 }}>
                        <Typography variant='h3'>Explore SubFarms</Typography>
                    </Container>
